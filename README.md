...
The [full website for the Senior Seminar (COMP 491/492)](http://htmlpreview.github.com/?./cs491f18/cs491f18.html) is included in the [cs491f18](./cs491f18) folder in this repository. The items below link to the course elements that focus specifically on the H/FOSS aspects of the course. Materials that were used in discussions of software engineering and (non-HFOSS) social/legal/ethical issues are not included here but do appear on the full site linked above. The materials below are organized by topic and can be assembled into a full H/FOSS capstone course.
